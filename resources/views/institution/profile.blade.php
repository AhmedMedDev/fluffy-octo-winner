                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                            href="/institution.profile">Overview</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_view_users" href="/institution.settings">Requests</a>
                    </li>
                    <!--end::Nav item-->
                </ul>
                <!--begin::Navs-->
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Federation Members</span>
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 min-w-300px rounded-start">Avatar</th>
                                <th class="min-w-125px">Type</th>
                                <th class="min-w-125px">Address</th>
                                <th class="min-w-150px">Rating</th>
                                <th class="min-w-150px">DOB</th>
                                <th class="min-w-100px">Activation</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-5">
                                            <span class="symbol-label bg-light">
                                                <img src="assets/media/avatars/player.jpg" class="h-75 align-self-end"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Brad
                                                Simmons</a>
                                            <span class="text-muted fw-bold text-muted d-block fs-7">Lorem ipsum dolor
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">Lorem
                                        ipsum</a>
                                    <span class="text-muted fw-bold text-muted d-block fs-7">Lorem </span>
                                </td>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">Lorem </a>
                                    <span class="text-muted fw-bold text-muted d-block fs-7">Lorem ipsum</span>
                                </td>
                                <td>
                                    <div class="rating">
								...
								<td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">25 Jan 1997</a>
                                </td>
								<td>
                                    <!--begin::Switch-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13">
                        <!--begin::Title-->
                        <h1 class="mb-3">Players Requests</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
